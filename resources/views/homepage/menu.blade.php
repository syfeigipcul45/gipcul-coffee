        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    <h5 class="mb-3">Eos kasd eos dolor vero vero, lorem stet diam rebum. Ipsum amet sed vero dolor
                        sea</h5>
                ...
                <div class="col-lg-4 py-5 py-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ asset('homepage/img/about.png')}}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    @foreach ($coffees as $value)
                        <div class="row align-items-center mb-5">
                            <div class="col-4 col-sm-3">
                                @if ($value->hasMedia('produk'))
                                    <img class="w-100 rounded-circle mb-3 mb-sm-0"
                                        src="{{ $value->getFirstMediaUrl('produk') }}" alt="">
                                @else
                                @endif
                                <h5 class="menu-price">{{ formatNumberToK($value->harga) }}</h5>
                            </div>
                            <div class="col-8 col-sm-9">
                                <h4>{{ $value->nama_produk }}</h4>
                                <p class="m-0">{{ strip_tags($value->deskripsi) }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 my-5 my-lg-0">
                        <div class="p-5">
                            ...
                            <p class="text-white">Lorem justo clita erat lorem labore ea, justo dolor lorem ipsum ut
                                sed eos,
                                ipsum et dolor kasd sit ea justo. Erat justo sed sed diam. Ea et erat ut sed diam sea
                            </p>
                            <ul class="list-inline text-white m-0">
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Lorem ipsum dolor sit
                                    amet</li>
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Lorem ipsum dolor sit
                                    amet</li>
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Lorem ipsum dolor sit
